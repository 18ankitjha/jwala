            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" method='POST' onSubmit ={handleSubmit}>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="remember" className="text-white light:text-gray-300">Remember me</label>
                    </div>
                  </div>
                  <Link href="/Forgot" className="text-sm font-medium text-primary-600 text-yellow-500 hover:text-orange-500   hover:underline light:text-primary-500">Forgot password?</Link>
                </div>
                ...
                <p className="text-sm font-light text-gray-500 light:text-gray-400">
                  ...
                  <Link href={"/Signup"} className="font-medium text-yellow-500 hover:text-red-600 text-primary-600 hover:underline light:text-primary-500">Sign up</Link>
                </p>
              </form>
            </div>
          </div>
